...
// Run this with: bun .sandcastle/main.ts
// Or add to package.json scripts: "sandcastle": "bun .sandcastle/main.ts"
...
await run({
  ...
  copyToWorktree: ["node_modules", "package.json", "bun.lock", "tsconfig.json"],
