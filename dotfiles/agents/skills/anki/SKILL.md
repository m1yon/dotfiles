...
When Michael says he doesn't like a card, first present exactly three distinct alternatives, numbered 1–3, with the proposed card text for each. Wait for him to choose before making any changes in Anki. For an existing Anki card, his choice authorizes updating the card with that alternative; apply it without asking for another confirmation. For a draft in the creation flow, his choice approves that version for the current round.
