...
-- Step one ===================================================================
-- Enable 'mini.base16' color scheme with Stylix-generated base16 palette.
-- The palette file is generated by Nix at ~/.local/share/nvim/stylix-base16.lua.
-- Changing the Stylix base16 scheme will automatically update Neovim's theme.
now(function()
  local colors_path = vim.fn.stdpath("data") .. "/stylix-base16.lua"
  local ok, colors = pcall(dofile, colors_path)
  if ok and colors then
    require("mini.base16").setup({ palette = colors })
  else
    vim.notify("Stylix base16 colors not found, using default colorscheme", vim.log.levels.WARN)
  end
end)
